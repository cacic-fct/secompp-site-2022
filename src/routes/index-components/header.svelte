...
<header style="background: linear-gradient(0deg, black 0%, rgb(33, 32, 13) 100%); padding-top: 50px">
  <div class="container">
    <div class="text-center intro-text">
      <div class="intro-lead-in" style="padding: 10px; padding-bottom: 24px; padding-top: 24px">
